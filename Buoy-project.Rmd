...
# Conclusion
  ...
  For future studies, a large dataset and a longer time span could be used to fit a more accurate and convincing model. Also, the time series could be performed to forecast future temperatures. Global warming is actually happening and everyone is responsible for trying to alleviate it.
...
5. Wickham,H. and Grolemund,G. (2016). *R for Data Science*. 1st ed. O'Reilly Media.
